defmodule IpMajor.CategorysTest do
  use IpMajor.DataCase

  alias IpMajor.Categorys

  describe "categorys" do
    alias IpMajor.Categorys.Category

    import IpMajor.CategorysFixtures

    @invalid_attrs %{description: nil, name: nil}

    test "list_categorys/0 returns all categorys" do
      category = category_fixture()
      assert Categorys.list_categorys() == [category]
    end
